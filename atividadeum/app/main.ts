...
while (execucao) {
    ...
    console.log(`18. Lista itens mais consumidos por tipo de pets `);
    console.log(`19. Lista geral de itens mais consumidos`);
    console.log(`20. Lista itens mais consumidos por tipo de pets`);
    console.log(`21. Top 5 clientes que mais consumiram (Valor)`);
