...
const CadastroServicos: React.FC = () => {
    ...
    async function submitForm(event: React.FormEvent<HTMLFormElement>) {
        ...
        const httpResponse: THttpResponse<any> = await fetch("http://localhost:8080/servico/new", {
            method: "POST",
        ...
        <form className="container mb-5" onSubmit={ (e) => submitForm(e) }>
            ...
            <h1 className="pb-4">
                ...
                <div className="mb-3">
                    ...
                    />
                    <div id="nomeHelp" className="form-text">Insira o nome do serviço.</div>
                </div>
                <div className="mb-3">
                    ...
                    />
                    <div id="valorHelp" className="form-text">Insira o valor do serviço</div>
                </div>
                <div className="mb-3">
            ...
            <div className="row justify-content-end">
                <button type="submit" className="col-md-3 btn btn-success custom-btn" style={{ backgroundColor: "#FF0000", color: "#FF0000", width:"160px" }}> Salvar alterações</button>
            </div>
        </form>
    )
}
